...
sudo apt install curl wget net-tools -y                         #algunas ya vienen instaladas, ademas net-tools supuestamente ya quedo viejo para usarlo pero es comun todavia encontrar tutoriales de como usarlo y por eso es que lo pongo igual
